...
export const ProductCard: React.FC<ProductCardProps> = ({ product, buttonStyle }) => {
  ...
  return (
    <div className="group relative bg-white border rounded-lg overflow-hidden shadow-sm hover:shadow-xl transition-shadow duration-300 flex flex-col">
      ...
      <div className="p-6 flex-grow">
        ...
        <p className="mt-4 text-xl font-bold text-gray-900">{product.price} Kč</p>
      </div>
