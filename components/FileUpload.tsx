    ...
    <div className="mt-8 space-y-4">
      <div className="flex items-center justify-between">
        <h3 className="text-sm font-bold text-gray-900 uppercase tracking-wider">
          ...
          {labelHint && <span className="text-brand-purple lowercase font-normal ml-1">{labelHint}</span>}
        </h3>
        ...
        <div className="flex flex-col items-center justify-center p-6 w-full">
          {uploading ? (
            <div className="text-center w-full max-w-xs">
                ...
                <p className="text-sm font-bold text-brand-purple mb-3">Ukládám... {progress}%</p>
            ...
            <>
              ...
              <p className="mb-2 text-base text-gray-800 font-bold text-center">Vyberte fotky</p>
              <p className="text-xs text-gray-500 uppercase font-medium tracking-widest bg-white/50 px-3 py-1 rounded-full border border-gray-100">JPG, PNG, WEBP</p>
            </>
          )}
        </div>
      ...
      {previews.length > 0 && (
        <div className="grid grid-cols-4 sm:grid-cols-6 gap-2 mt-4 p-2 bg-gray-50 rounded-xl border border-gray-100">
          {previews.map((url, i) => (
            <div key={i} className="aspect-square rounded-lg overflow-hidden border-2 border-white shadow-sm bg-white">
