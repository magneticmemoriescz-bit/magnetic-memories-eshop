...
export const PRODUCTS: Product[] = [
  {
    ...
    imageUrl: 'https://i.imgur.com/2s3j4oX.jpeg',
    gallery: [
        'https://i.imgur.com/aJ4Q8zH.jpeg',
        'https://i.imgur.com/rG7b7oE.jpeg',
        'https://i.imgur.com/pY6v9Yg.jpeg',
    ],
    imageUrl_portrait: 'https://i.imgur.com/2s3j4oX.jpeg',
    gallery_portrait: [
        'https://i.imgur.com/aJ4Q8zH.jpeg',
        'https://i.imgur.com/rG7b7oE.jpeg',
        'https://i.imgur.com/pY6v9Yg.jpeg',
    ],
    imageUrl_landscape: 'https://i.imgur.com/w4o6FkL.jpeg',
    gallery_landscape: [
        'https://i.imgur.com/w4o6FkL.jpeg',
        'https://i.imgur.com/YvJ2zZ8.jpeg',
        'https://i.imgur.com/N7f4e7C.jpeg'
    ],
    requiredPhotos: 12,
    variants: [
  ...
  },
  {
    ...
    imageUrl: 'https://i.imgur.com/3ZgS9iL.jpeg',
    gallery: [
      'https://i.imgur.com/oP9wB1V.jpeg',
      'https://i.imgur.com/9iF8zUu.jpeg',
      'https://i.imgur.com/M6x2t4N.jpeg',
    ],
    requiredPhotos: 1,
    hasTextFields: false,
    variants: [
  ...
  },
  {
    ...
    imageUrl: 'https://i.imgur.com/CAb32dG.jpeg',
    gallery: [
    ...
    variants: [
      { id: '6-large', name: '6 ks (10x10 cm)', photoCount: 6, price: 100 },
      { id: '12-small', name: '12 ks (5x5 cm)', photoCount: 12, price: 180 },
    ]
  }
];
