...
export const PRODUCTS: Product[] = [
  {
    ...
    requiredPhotos: 1,
    variants: [
      { id: '5x5', name: '5x5 cm', photoCount: 1, itemCount: 1, price: 35, imageUrl: 'https://i.imgur.com/1oIzU4r.jpeg' },
      { id: '7x7', name: '7x7 cm', photoCount: 1, itemCount: 1, price: 40, imageUrl: 'https://i.imgur.com/1oIzU4r.jpeg' },
      { id: '5x10', name: '5x10 cm', photoCount: 1, itemCount: 1, price: 40, imageUrl: 'https://i.imgur.com/miugWFP.jpg' },
      { id: '10x10', name: '10x10 cm', photoCount: 1, itemCount: 1, price: 45, imageUrl: 'https://i.imgur.com/nPJfjfu.jpg' },
      { id: '9x13', name: '9x13 cm', photoCount: 1, itemCount: 1, price: 50, imageUrl: 'https://i.imgur.com/miugWFP.jpg' },
      { id: 'a6', name: 'A6', photoCount: 1, itemCount: 1, price: 55, imageUrl: 'https://i.imgur.com/miugWFP.jpg' },
      { id: 'a5-sheet', name: 'A5', photoCount: 1, itemCount: 1, price: 100, imageUrl: 'https://i.imgur.com/miugWFP.jpg' },
      { id: 'a4-sheet', name: 'A4', photoCount: 1, itemCount: 1, price: 120, imageUrl: 'https://i.imgur.com/miugWFP.jpg' },
    ]
  },
  {
  ...
  },
  {
    ...
    price: 55,
    shortDescription: 'Originální magnetická oznámení pro váš velký day.',
  ...
  },
  {
    ...
    requiredPhotos: 0, 
    variants: [
      { id: '5x5', name: '5x5 cm', photoCount: 0, itemCount: 1, price: 35 },
      { id: '7x7', name: '7x7 cm', photoCount: 0, itemCount: 1, price: 40 },
      { id: '10x10', name: '10x10 cm', photoCount: 0, itemCount: 1, price: 45 },
    ]
  },
  {
    ...
    requiredPhotos: 12,
    variants: [
      { id: '8x10', name: '8x10 cm', photoCount: 12, itemCount: 1, price: 360 },
      { id: 'a6', name: 'A6', photoCount: 12, itemCount: 1, price: 560 },
      { id: 'a5', name: 'A5', photoCount: 12, itemCount: 1, price: 690 },
      { id: 'a4', name: 'A4', photoCount: 12, itemCount: 1, price: 910 },
    ]
  },
  {
    id: 'magnetic-merch',
    ...
    requiredPhotos: 1,
    variants: [
      { id: '5x5', name: '5x5 cm', photoCount: 1, itemCount: 1, price: 35, imageUrl: 'https://i.imgur.com/TNmq31E.jpg' },
      { id: '7x7', name: '7x7 cm', photoCount: 1, itemCount: 1, price: 40, imageUrl: 'https://i.imgur.com/TNmq31E.jpg' },
      { id: '5x10', name: '5x10 cm', photoCount: 1, itemCount: 1, price: 40, imageUrl: 'https://i.imgur.com/TNmq31E.jpg' },
      { id: '10x10', name: '10x10 cm', photoCount: 1, itemCount: 1, price: 45, imageUrl: 'https://i.imgur.com/TNmq31E.jpg' },
      { id: '9x13', name: '9x13 cm', photoCount: 1, itemCount: 1, price: 50, imageUrl: 'https://i.imgur.com/miugWFP.jpg' },
      { id: 'a6', name: 'A6', photoCount: 1, itemCount: 1, price: 55, imageUrl: 'https://i.imgur.com/miugWFP.jpg' },
      { id: 'a5-sheet', name: 'A5', photoCount: 1, itemCount: 1, price: 100, imageUrl: 'https://i.imgur.com/miugWFP.jpg' },
      { id: 'a4-sheet', name: 'A4', photoCount: 1, itemCount: 1, price: 120, imageUrl: 'https://i.imgur.com/miugWFP.jpg' },
