        ...
        <>
            ...
            <section className="relative bg-white flex items-center justify-center min-h-screen text-white p-4 sm:p-6 lg:p-8">
                <div className="absolute inset-0">
                    <img className="w-full h-full object-cover" src="https://i.imgur.com/MiDTen1.jpeg" alt="Lednice s magnety" />
...
const CheckoutPage: React.FC = () => {
    ...
    const sendEmailNotifications = async (order: OrderDetails) => {
        ...
        const ownerParams = {
            ...
            shipping_address: `${order.contact.street}<br>${order.contact.zip} ${order.contact.city}`,
